...
# NUEVA FUNCIÓN: Editar cliente existente
...
def generate_invoice_pdf(order_id: int, invoice_number: int) -> str:
    ...
    tbl_products.setStyle(TableStyle([
        ...
        ('VALIGN', (0,0), (-1,-1), 'MIDDLE'), # <-- CORRECCIÓN: 'MIDDLER' a 'MIDDLE'
    ]))
...
# ---------------------------
# CLIENTES (CON FUNCIÓN DE EDICIÓN)
# ---------------------------
elif menu == "Clientes":
    st.header("👥 Clientes")
    df_clients = load_df("Clientes")
    ...
    # NUEVO: Formulario para editar cliente existente
        ...
        if df_clients.empty:
            ...
            if selected_client_option != "-- Seleccionar --":
                ...
                with st.form(key="edit_client_form"):
                    ...
                    col1, col2 = st.columns(2)
                    with col1:
                        # Manejar casos donde el tipo de documento no exista
